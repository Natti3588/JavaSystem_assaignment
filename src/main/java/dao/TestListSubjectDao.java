...
public class TestListSubjectDao extends Dao {
  ...
  String baseSql = "SELECT " + "t.NO AS test_no, " + "t.POINT , " + "s.CLASS_NUM , "
      + "s.ENT_YEAR , " + "s.NO AS student_no, " + "s.NAME AS student_name " + "FROM student s "
      + "LEFT JOIN test t " + "ON t.STUDENT_NO = s.NO " + "AND t.SUBJECT_CD = ? "
